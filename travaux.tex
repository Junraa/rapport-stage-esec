...
\section{Moteur d'exécution concolique}
\myparagraph{Pourquoi de l'exécution symbolique ?}
...
Il dispose également d'un moteur d'exécution symbolique et est très complet dans ses fonctionnalités, permettant de récupérer pleins d'information via
...
\begin{itemize}
    ...
    \item Les blocs se finissent tous par une assignation de l'identifiant \textbf{IRDst}, indiquant le prochain basic blocs dans l'exécution.
